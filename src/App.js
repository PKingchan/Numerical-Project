...
import './screen.css';
import { BookFilled,PieChartOutlined,RadarChartOutlined } from '@ant-design/icons';
...
class App extends Component {
  ...
  render() {
    return (
      <Router>
        <Layout>
          <Header className="header" style={{backgroundColor:"#4A056E",color:"#e89a3c" ,height: "100px" }}>
            <div className="headertext">
              <label><RadarChartOutlined  style={{color:"#FFF238" ,fontSize:"50px", marginRight:"10px"}} />Numerical Method</label>
            </div>
          </Header>
          <Layout>
          <Sider width={335} style={{ background: "#fff" }}>
              <Menu
                mode="inline"
                style={{ height: '90vh', borderRight: 0, backgroundColor: "#FFF9A6", overflowY: "scroll" }}
                theme="light"
              >
          ...
          <Footer style={{ backgroundColor: "#A572D8", minHeight: 120 }}>
